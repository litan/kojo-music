...
object QuickBeat {
  ...
  val bd_w = Beat(Percussion.BASS_DRUM_1, w)
  val bd_h = Beat(Percussion.BASS_DRUM_1, h)
  val bd = Beat(Percussion.BASS_DRUM_1, q)
  val bd_i = Beat(Percussion.BASS_DRUM_1, i)
  val bd_s = Beat(Percussion.BASS_DRUM_1, s)
  val bd_t = Beat(Percussion.BASS_DRUM_1, t)
