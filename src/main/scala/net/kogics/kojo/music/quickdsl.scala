...
object QuickBeat {
  val pbd_w = Beat(Percussion.ACOUSTIC_BASS_DRUM, w)
  val pbd_h = Beat(Percussion.ACOUSTIC_BASS_DRUM, h)
  val pbd = Beat(Percussion.ACOUSTIC_BASS_DRUM, q)
  val pbd_i = Beat(Percussion.ACOUSTIC_BASS_DRUM, i)
  val pbd_s = Beat(Percussion.ACOUSTIC_BASS_DRUM, s)
  val pbd_t = Beat(Percussion.ACOUSTIC_BASS_DRUM, t)

  val phc_w = Beat(Percussion.HAND_CLAP, w)
  val phc_h = Beat(Percussion.HAND_CLAP, h)
  val phc = Beat(Percussion.HAND_CLAP, q)
  val phc_i = Beat(Percussion.HAND_CLAP, i)
  val phc_s = Beat(Percussion.HAND_CLAP, s)
  val phc_t = Beat(Percussion.HAND_CLAP, t)

  // generated via quickbeat_maker.kojo

  val abd_w = Beat(Percussion.ACOUSTIC_BASS_DRUM, w)
  val abd_h = Beat(Percussion.ACOUSTIC_BASS_DRUM, h)
  val abd = Beat(Percussion.ACOUSTIC_BASS_DRUM, q)
  val abd_i = Beat(Percussion.ACOUSTIC_BASS_DRUM, i)
  val abd_s = Beat(Percussion.ACOUSTIC_BASS_DRUM, s)
  val abd_t = Beat(Percussion.ACOUSTIC_BASS_DRUM, t)

  val bdr_w = Beat(Percussion.BASS_DRUM_1, w)
  val bdr_h = Beat(Percussion.BASS_DRUM_1, h)
  val bdr = Beat(Percussion.BASS_DRUM_1, q)
  val bdr_i = Beat(Percussion.BASS_DRUM_1, i)
  val bdr_s = Beat(Percussion.BASS_DRUM_1, s)
  val bdr_t = Beat(Percussion.BASS_DRUM_1, t)

  val stk_w = Beat(Percussion.SIDE_STICK, w)
  val stk_h = Beat(Percussion.SIDE_STICK, h)
  val stk = Beat(Percussion.SIDE_STICK, q)
  val stk_i = Beat(Percussion.SIDE_STICK, i)
  val stk_s = Beat(Percussion.SIDE_STICK, s)
  val stk_t = Beat(Percussion.SIDE_STICK, t)

  val snr_w = Beat(Percussion.ACOUSTIC_SNARE, w)
  val snr_h = Beat(Percussion.ACOUSTIC_SNARE, h)
  val snr = Beat(Percussion.ACOUSTIC_SNARE, q)
  val snr_i = Beat(Percussion.ACOUSTIC_SNARE, i)
  val snr_s = Beat(Percussion.ACOUSTIC_SNARE, s)
  val snr_t = Beat(Percussion.ACOUSTIC_SNARE, t)

  val clp_w = Beat(Percussion.HAND_CLAP, w)
  val clp_h = Beat(Percussion.HAND_CLAP, h)
  val clp = Beat(Percussion.HAND_CLAP, q)
  val clp_i = Beat(Percussion.HAND_CLAP, i)
  val clp_s = Beat(Percussion.HAND_CLAP, s)
  val clp_t = Beat(Percussion.HAND_CLAP, t)

  val hbg_w = Beat(Percussion.HI_BONGO, w)
  val hbg_h = Beat(Percussion.HI_BONGO, h)
  val hbg = Beat(Percussion.HI_BONGO, q)
  val hbg_i = Beat(Percussion.HI_BONGO, i)
  val hbg_s = Beat(Percussion.HI_BONGO, s)
  val hbg_t = Beat(Percussion.HI_BONGO, t)

  val lbg_w = Beat(Percussion.LOW_BONGO, w)
  val lbg_h = Beat(Percussion.LOW_BONGO, h)
  val lbg = Beat(Percussion.LOW_BONGO, q)
  val lbg_i = Beat(Percussion.LOW_BONGO, i)
  val lbg_s = Beat(Percussion.LOW_BONGO, s)
  val lbg_t = Beat(Percussion.LOW_BONGO, t)

  val mhc_w = Beat(Percussion.MUTE_HI_CONGA, w)
  val mhc_h = Beat(Percussion.MUTE_HI_CONGA, h)
  val mhc = Beat(Percussion.MUTE_HI_CONGA, q)
  val mhc_i = Beat(Percussion.MUTE_HI_CONGA, i)
  val mhc_s = Beat(Percussion.MUTE_HI_CONGA, s)
  val mhc_t = Beat(Percussion.MUTE_HI_CONGA, t)

  val ohc_w = Beat(Percussion.OPEN_HI_CONGA, w)
  val ohc_h = Beat(Percussion.OPEN_HI_CONGA, h)
  val ohc = Beat(Percussion.OPEN_HI_CONGA, q)
  val ohc_i = Beat(Percussion.OPEN_HI_CONGA, i)
  val ohc_s = Beat(Percussion.OPEN_HI_CONGA, s)
  val ohc_t = Beat(Percussion.OPEN_HI_CONGA, t)

  val lhc_w = Beat(Percussion.LOW_CONGA, w)
  val lhc_h = Beat(Percussion.LOW_CONGA, h)
  val lhc = Beat(Percussion.LOW_CONGA, q)
  val lhc_i = Beat(Percussion.LOW_CONGA, i)
  val lhc_s = Beat(Percussion.LOW_CONGA, s)
  val lhc_t = Beat(Percussion.LOW_CONGA, t)

  val swh_w = Beat(Percussion.SHORT_WHISTLE, w)
  val swh_h = Beat(Percussion.SHORT_WHISTLE, h)
  val swh = Beat(Percussion.SHORT_WHISTLE, q)
  val swh_i = Beat(Percussion.SHORT_WHISTLE, i)
  val swh_s = Beat(Percussion.SHORT_WHISTLE, s)
  val swh_t = Beat(Percussion.SHORT_WHISTLE, t)

  val lwh_w = Beat(Percussion.LONG_WHISTLE, w)
  val lwh_h = Beat(Percussion.LONG_WHISTLE, h)
  val lwh = Beat(Percussion.LONG_WHISTLE, q)
  val lwh_i = Beat(Percussion.LONG_WHISTLE, i)
  val lwh_s = Beat(Percussion.LONG_WHISTLE, s)
  val lwh_t = Beat(Percussion.LONG_WHISTLE, t)

  val cla_w = Beat(Percussion.CLAVES, w)
  val cla_h = Beat(Percussion.CLAVES, h)
  val cla = Beat(Percussion.CLAVES, q)
  val cla_i = Beat(Percussion.CLAVES, i)
  val cla_s = Beat(Percussion.CLAVES, s)
  val cla_t = Beat(Percussion.CLAVES, t)

  val hwb_w = Beat(Percussion.HI_WOOD_BLOCK, w)
  val hwb_h = Beat(Percussion.HI_WOOD_BLOCK, h)
  val hwb = Beat(Percussion.HI_WOOD_BLOCK, q)
  val hwb_i = Beat(Percussion.HI_WOOD_BLOCK, i)
  val hwb_s = Beat(Percussion.HI_WOOD_BLOCK, s)
  val hwb_t = Beat(Percussion.HI_WOOD_BLOCK, t)

  val lwb_w = Beat(Percussion.LOW_WOOD_BLOCK, w)
  val lwb_h = Beat(Percussion.LOW_WOOD_BLOCK, h)
  val lwb = Beat(Percussion.LOW_WOOD_BLOCK, q)
  val lwb_i = Beat(Percussion.LOW_WOOD_BLOCK, i)
  val lwb_s = Beat(Percussion.LOW_WOOD_BLOCK, s)
  val lwb_t = Beat(Percussion.LOW_WOOD_BLOCK, t)
}
